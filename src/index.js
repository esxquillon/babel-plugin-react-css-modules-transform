        ...
        visitor: {
            ...
            ImportDefaultSpecifier(path, { file }) {
                ...
                if (matchExtensions.test(value)) {
                    ...
                    const target_css = join(dirname(requiringFile), value);
                    ...
                    const injectGeneratedCSS = t.identifier(`(function() { var node = document.createElement('style'); node.type = 'text/css'; node.innerHTML = ${JSON.stringify(cssMap.get(target_css))}; document.getElementsByTagName("head")[0].appendChild(node); })();`);
